...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 676.3021240234375, 724.21337890625, 65.0, 22.0 ],
					"text" : "pastebang"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 676.3021240234375, 816.385009765625, 85.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 446.539703369140625, 788.385009765625, 258.0, 22.0 ],
					"text" : "mc.scale~ 0. 120. -5. 5. @busymapname beap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 716.8021240234375, 1029.399658203125, 176.0, 22.0 ],
					"text" : "mc.poly~ bp.FM-OD @voices 8"
				}
...
, 			{
				"box" : 				{
					...
					"presentation" : 1,
					"presentation_rect" : [ 81.586616516113281, 66.338157653808594, 96.413375854492188, 19.0 ],
...
,
					"patching_rect" : [ 502.320953369140625, 632.6864013671875, 69.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 446.539703369140625, 294.992279052734375, 180.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 446.539703369140625, 722.6864013671875, 166.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 984.283447265625, 242.485427856445312, 36.0, 20.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1105.6893310546875, 159.887710571289062, 44.0, 23.0 ],
					"text" : "sig~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 984.283447265625, 365.485382080078125, 180.0, 22.0 ],
					"text" : "mc.-~ 60 @busymapname beap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 984.283447265625, 331.1461181640625, 56.0, 22.0 ],
					"text" : "mc.*~ 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 984.283447265625, 293.1461181640625, 176.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 653.5396728515625, 176.992279052734375, 36.0, 20.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 653.5396728515625, 111.394561767578125, 25.0, 25.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 774.9459228515625, 94.394561767578125, 44.0, 23.0 ],
					"text" : "sig~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 653.5396728515625, 294.992279052734375, 180.0, 22.0 ],
					"text" : "mc.-~ 60 @busymapname beap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 446.539703369140625, 408.76165771484375, 166.0, 22.0 ],
					"text" : "mc.+~ @busymapname beap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 446.539703369140625, 356.922454833984375, 166.0, 22.0 ],
					"text" : "mc.+~ @busymapname beap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 653.5396728515625, 265.652984619140625, 56.0, 22.0 ],
					"text" : "mc.*~ 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 653.5396728515625, 227.652984619140625, 176.0, 22.0 ],
					"text" : "mc.+~ 5 @busymapname beap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 446.539703369140625, 237.990631103515625, 56.0, 22.0 ],
					"text" : "mc.*~ 12"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 446.539703369140625, 200.490631103515625, 176.0, 22.0 ],
					"text" : "mc.+~ 5 @busymapname beap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 17.173828125, 176.992279052734375, 56.0, 22.0 ],
					"restore" : 					{
						"CV2" : [ 0.0 ],
						"CV3" : [ 0.0 ],
						"Color" : [ 0.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 1464.7696533203125, 921.887939453125, 137.0, 35.0 ],
					"text" : "mc.*~ @busymapname beap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 1383.5196533203125, 973.4354248046875, 166.0, 22.0 ],
					"text" : "mc.+~ @busymapname beap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 1131.4111328125, 867.6591796875, 40.0, 22.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 1050.160888671875, 919.2066650390625, 166.0, 22.0 ],
					"text" : "mc.+~ @busymapname beap"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 643.04327392578125, 1134.5755615234375, 202.0, 22.0 ],
					"text" : "mc.gate~ 1 1 @busymapname beap"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 683.5396728515625, 111.394561767578125, 28.0, 17.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 17.173828125, 66.121551513671875, 111.0, 17.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 2.0, 19.0, 111.0, 17.0 ],
					"text" : "mc.MACRO OSCILLATOR",
					"textcolor" : [ 1.0, 1.0, 1.0, 1.0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 511.820953369140625, 661.686401000000046, 493.210999000000015, 661.686401000000046, 493.210999000000015, 460.790099999999995, 554.820922999999993, 460.790099999999995 ],
					"source" : [ "obj-32", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 536.820953369140625, 661.686401000000046, 676.591552999999976, 661.686401000000046, 676.591552999999976, 455.47543300000001, 611.582031000000029, 455.47543300000001 ],
					"source" : [ "obj-32", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-32", 0 ],
					"midpoints" : [ 554.820922999999993, 549.936401000000046, 511.820953369140625, 549.936401000000046 ],
					"source" : [ "obj-46", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 611.582031000000029, 573.936401000000046, 536.820953369140625, 573.936401000000046 ],
					"source" : [ "obj-51", 0 ]
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-12" : [ "Mute", "Mute", 0 ],
			"obj-129" : [ "CV2", "CV2", 0 ],
			"obj-25" : [ "TimbreCV", "CV", 0 ],
			"obj-3" : [ "Timbre", "Timbre", 0 ],
			"obj-35::obj-2" : [ "pastebang", "pastebang", 0 ],
			"obj-45" : [ "FreqMode", "FreqMode", 0 ],
			"obj-46" : [ "Offset", "Offset", 0 ],
			"obj-51" : [ "Freq", "Freq", 0 ],
			"obj-80" : [ "ColorCV", "CV", 0 ],
			"obj-81" : [ "Color", "Color", 0 ],
			"obj-9" : [ "Macro", "Macro", 0 ],
			"parameterbanks" : 			{
